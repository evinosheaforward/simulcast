  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-800 to-black text-white">
      <div className="grid place-items-center text-center text-white rounded-lg">
        <header className="w-full max-w-4xl bg-gray-950 place-items-center text-white py-4 shadow-xl">
      ...
      <div className="grid h-full overflow-y-auto place-items-center">
        <div className="w-full max-w-4xl bg-gray-900 rounded-lg shadow-xl gap-1">
          {children}
        </div>
      </div>
    </div>
