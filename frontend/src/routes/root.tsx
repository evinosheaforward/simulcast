  ...
  return (
    <PageFrame>
      ...
      <section className="items-center grid place-items-center w-full">
        ...
        <div className="place-items-center w-full max-w-3xl p-6 border border-gray-700 rounded bg-gray-800 shadow-xl">
      ...
      <section className="grid grid-cols-1 place-items-center py-8 text-white">
        ...
        <div className="w-full max-w-3xl p-4 border border-gray-700 rounded bg-gray-800">
          <ul className="mx-auto text-left list-disc list-inside p-2 space-y-2 text-white">
            ...
            <li>
              You can play any number of cards so long as you have enough Mana.
            </li>
            <li>
            ...
            <li>
              Whoever <b>did not</b> have the last card activation in the round
              will go <b>First</b> in the next round.
            </li>
            <li>
